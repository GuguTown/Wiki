...
### 武器装备
在【武器装备】选项卡中，玩家可以调整战斗中要使用的装备和要携带的饰品，也可以进行装备的熔炼/丢弃，饰品的强化，还可以使用获得的道具。
在【我的仓库】中点击装备，可以选择【穿上装备】、【丢弃装备】、【熔炼该装备为护身符】。   
在【我的仓库】中点击护身符，可以选择【放入我的饰品栏】、【销毁该护身符】。  
在【我的饰品】中点击护身符，可以选择【放入仓库】。  
#### 道具
点击【我的仓库】中的道具，即可使用该道具，无二次确认。
#### 穿上装备
点击后将使用当前选择的装备替换掉之前装载的装备，之前装载的装备放入仓库中。
#### 丢弃装备
点击后将把当前选择的装备从仓库丢弃到沙滩上，在24小时内可以重新拾取。
#### 熔炼该装备为护身符
点击后将把当前选择的装备熔炼为护身符，护身符品质与种类与装备的等级与品质正相关，对于史诗级以上装备，需要输入124进行确认才可以熔炼。
#### 放入我的饰品栏
点击后将把当前选择的护身符放入饰品栏，使所选护身符的效果生效。
#### 销毁该护身符
点击后将把当前选择的护身符销毁，视强化次数获得不等数量的果核，对于史诗以上护身符，需要输入124进行确认才可以销毁。
#### 放入仓库
点击后将把当前选择的护身符放回仓库，所选护身符不再生效。
### 角色卡片
在【角色卡片】选项卡中，可以选择去争夺战场进行战斗的角色，调整角色的加点，设置战斗中获得经验的角色。
