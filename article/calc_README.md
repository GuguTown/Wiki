# 咕咕镇计算器
**作者：brutelor**   
[咕咕镇计算器0.4.5.5版](../src/app/newkf0.4.5.5.rar)   
...
#### 一般格式的PC
```
[ATK|DEF] [W=<权重>] <PC类型> [G=<成长值>] <等级> <技能位> <品质>
[WISH <七项许愿池点数>]
...
七项许愿池点数依次为生命药水、护盾药水、启程之誓、启程之心、启程之风、野怪伤害增强、野怪生命增强。   
...
#### 可用的NPC类型名
`MU`(木人)、`ZHU`(迅捷蛛)、`DENG`(魔灯)、`SHOU`(食铁兽)、`MU2`(新版木人)、`ZHU2`(新版魔蛛)、`DENG2`(新版魔灯)、`SHOU2`(新版食铁兽)、`YU2`(飞鱼)、`HAO2`(豪猪)
#### 可用的装备类型名  
